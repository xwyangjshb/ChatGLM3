...
model_path = "/home/bvs/.cache/modelscope/hub/ZhipuAI/glm-4-9b-chat-1m"
model_path = "/home/bvs/.cache/modelscope/hub/ZhipuAI/glm-4-9b-chat"
...
with gr.Blocks() as demo:
    gr.HTML("""<h1 align="center">ChatGLM4-9B-chat</h1>""")
...
demo.queue().launch(share=True, server_name="0.0.0.0", server_port=8502, inbrowser=True)
